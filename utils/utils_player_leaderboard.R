...
add_percentiles <- function(df) {
  metrics_to_iterate <- c("thrower_aec", "Assists", "cpoe", "turnovers",
                          "receiver_aec", "Goals", "Blocks", "defensive_efficiency",
                          "offensive_involvement", "offensive_efficiency", "total_aec")
